...
api.style.css += fs.readFileSync(__dirname + '/style/prism.css');
api.style.css += fs.readFileSync(__dirname + '/style/main.css');
...
var convertString = api.convertString = function (inputString) {
	...
	var result = '<html><head><title>' + titleText.replace(/</g, '&lt;') + '</title>';
